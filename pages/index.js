  ...
  */
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>jessica tian</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/winter_polar_bear_icon.ico" />
      </Head>

      <main className="bg-pink-100 px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <div className="flex flex-col items-center justify-center h-screen fixed top-0 right-0 bg-pink-200 dark:bg-gray-800 p-4">
          ...
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            ...
            <ul className="flex items-center">
              ...
              <li>
              <a
                href="/public/jtianresume.pdf" // Adjust the path to your PDF file
                download="jtianresume.pdf" // Specify the desired file name for download
                className="bg-gradient-to-r from-pink-500 to-cyan-500 to-teal-500 text-white px-4 py-2 border-none rounded-md ml-8"
              >
                resume
              </a>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center">
            ...
            <div className={`w-full md:w-1/2 opacity-${showFirstImage ? "100" : "0"} transition-opacity duration-500`}>
              <div className="mx-auto bg-gradient-to-b from-teal-500 to-cyan-500 to-pink-500 rounded-full w-96 h-96 relative overflow-hidden md:h-96 md:w-96">
            ...
            <div className="w-full md:w-1/2 p-10 mt-[10rem]">
              ...
              <button
                onClick={toggleImage}
                className="bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-4 py-2 rounded-md hover:bg-teal-600 transition duration-300 ease-in-out"
              >
                profile swap
              </button>
            </div>
